...
func Claims() []Claim {
	return []Claim{
		...
		{"Every .kas name is a Web4.0 agent", Indexer, "This app synthesizes an ERC-8004-shaped agent card and a Kaspa 402 challenge from indexer records. There is no on-chain agent registry on Kaspa. MCP/A2A endpoints are this process.", "this repo; EIP-8004 registration file shape"},
